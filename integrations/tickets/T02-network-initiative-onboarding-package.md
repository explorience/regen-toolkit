...
- **Priority:** P0
- **Status:** IN_PROGRESS
- **Workspace:** `integrations/sync/package-workspaces/T02-network-initiative-onboarding-package/`

## Mission
Ship a reusable package for: regen-toolkit module + ReFi-DAO-Website community/network-initiatives
...
- `03 Libraries/ReFi-DAO-Website/content/resources-hub/onboarding/network-initiative.md`

## Expected package outputs
- Initiative onboarding package (guide + quick-start)
- Funding and governance pathway summary
- Website copy block for ReFi-DAO-Website
- Validation checklist + release notes

## Dependencies
- Depends on T04 for shared Quartz publishing workflow.
