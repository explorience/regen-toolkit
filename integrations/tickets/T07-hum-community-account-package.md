# T07 — Hum Community Account Package

- **Owner:** Luiz + network facilitators
- **Priority:** P1
- **Status:** OPEN
- **Workspace:** `integrations/sync/package-workspaces/T07-hum-community-account-package/`

## Mission
Ship a reusable package for: Mobile governance onboarding package (demo → adoption)

## Source bundle (canonical)
- `03 Libraries/Regenerant-Catalunya/docs/phase-2/tools/hum-community-implementation-plan.md`
- `03 Libraries/Regenerant-Catalunya/docs/phase-2/tools/hum-community-demo-facilitator-script-es.md`
- `03 Libraries/Regenerant-Catalunya/docs/phase-2/tools/hum-community-internal-demo-rehearsal-es.md`

## Expected package outputs
- Demo script + onboarding guide
- Adoption decision framework (demo-only vs full deployment)
- Governance and facilitation checklist
- Validation checklist + release notes

## Dependencies
- Uses T03 reporting standards + may pair with T06 for treasury execution.
