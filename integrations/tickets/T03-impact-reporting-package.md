...
- **Priority:** P0
- **Status:** IN_PROGRESS
- **Workspace:** `integrations/sync/package-workspaces/T03-impact-reporting-package/`

## Mission
Ship a reusable package for: regen-toolkit/integrations SOP + reusable reporting templates

## Source bundle (canonical)
- `03 Libraries/coop/skills/impact-reporting/SKILL.md`
- `03 Libraries/Regenerant-Catalunya/docs/project-reports/prompts/01-prepare-file-analysis.md`
- `03 Libraries/Regenerant-Catalunya/docs/project-reports/prompts/02-generate-report.md`
- `03 Libraries/Regenerant-Catalunya/docs/project-reports/prompts/03-evaluate-report.md`

## Expected package outputs
- Impact reporting SOP (capture → extract → report → evaluate)
- Prompt chain package with examples
- Template files for activity reports and QA evaluation
- Validation checklist + release notes

## Dependencies
- Feeds T06/T07/T08 with reporting and evidence standards.
...
- [x] Run VALIDATION-CHECKLIST.md (preliminary pass; worked example added; owner sign-off pending)

## Latest execution update (2026-03-08)
- [x] Stage 3 complete: Draft Build with worked example (La Marmita)
