# T05 — ReFi-DAO-Website Equivalent Package

- **Owner:** Luiz (lead)
- **Priority:** P0
- **Status:** OPEN
- **Workspace:** `integrations/sync/package-workspaces/T05-refi-dao-website-equivalent-package/`

## Mission
Ship a reusable package for: Equivalent version aligned with BCN/Mediterranean/Provence baselines
...
- DAO website parity plan
- Content + nav + taxonomy equivalence checklist
- Implementation patches list
- Validation checklist + release notes

## Dependencies
- Consumes T04 standards.
