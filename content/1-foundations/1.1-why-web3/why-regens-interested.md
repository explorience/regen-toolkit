...
- **Community treasuries** — Groups can pool money together and decide together how to spend it [Source A]
- **Regenerative finance (ReFi)** — Financial systems designed to restore ecosystems, not just make profits [Source A]
- **Quadratic funding** — A fairer way to decide which projects get money, where small donations count for more [Source A]
...
- **DAOs** (Decentralized Autonomous Organizations) — Groups that make decisions together using votes anyone can verify [Source B]
- **Proof of contribution** — Ways to recognize and reward people for their work, without a boss deciding who deserves what [Source A]
...
- **Self-custody** — Keeping control of your own assets without needing a bank or company in the middle [Source S]
- **Local tokens** — Money designed to stay and circulate in your community

## The Greenpill Story

One real example comes from the Greenpill Network, a community that's been exploring these questions since early in the web3 space. They've developed a 147-page guide for local regeneration that bridges "crypto-native concepts with on-the-ground community organizing" [Source B].
...
2. **Learn the basics** — The Ottawa Web3 Starter Guide offers hands-on, workshop-tested onboarding that assumes no prior knowledge [Source S]
...
As the Greenpill Local Regen Guide puts it, blockchain tools can serve regenerative goals when communities choose to use them that way [Source B].
