...
description: Learn how on-chain attestations create verifiable proof of skills, achievements, and impact.
...
- Lasts forever without needing to keep physical documents

That's exactly what an **on-chain attestation** does!

An attestation is like a digital certificate or proof record that lives on something called a "blockchain." Think of a blockchain as a special digital notebook that many people share and nobody can erase. When someone creates an attestation about you, it's written into this notebook forever.

## How Do Attestations Create Proof?

Here's how it works in simple steps:

**1. Someone vouches for you**
...
On-chain attestations can be used for many things in your journey:
...
Some programs and scholarships are starting to use attestations to decide who qualifies. By having your achievements recorded as verifiable proof, you might unlock access to new opportunities that require proof of skills or experience.
