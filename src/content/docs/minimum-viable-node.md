...
| "Who decided that?" keeps coming up | Lightweight roles plus simple majority votes |
| You're voting often and want it free and verifiable | **Snapshot**: gasless, signature-based voting used by tens of thousands of communities |
...
- [Grassroots Economics, Sarafu Network](https://www.grassrootseconomics.org/sarafu-network), the Kenyan community-currency network that started small and grew to tens of thousands of businesses on Celo.
