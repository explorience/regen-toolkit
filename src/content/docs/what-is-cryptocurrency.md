...
**Giving that funds itself.** **Glo Dollar** is a nonprofit digital dollar: the reserves backing it sit in cash and safe US government bonds, and the interest those reserves earn is donated to charities the holder chooses. A major recipient is **GiveDirectly**, which hands cash straight to people in extreme poverty. Holding it routes money to good causes at no cost to you.
...
**"Isn't this terrible for the planet?"** It depends entirely on *which* blockchain. Bitcoin still uses **proof of work**, a system that secures the network by burning electricity, and as of 2025 it consumes roughly as much power each year as a mid-sized country like Poland, on the order of 140 to 170 terawatt-hours, according to the Cambridge Centre for Alternative Finance. But in 2022 Ethereum switched to **proof of stake**, which secures the network without the energy race, and cut its electricity use by about 99.95% overnight. Most newer chains work this way, including Celo, the one the projects above use. "Crypto wrecks the climate" was largely a Bitcoin story. Judge each project by the chain it runs on.
