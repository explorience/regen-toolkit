...
description: "Concrete funding patterns, real tools, and the pitfalls to avoid when you're standing up a local regen node and want it to last."
---
...
- **Treasury:** a **multisig**, a shared crypto wallet that needs several people to approve any spend, so no single person controls the funds. [Safe](https://safe.global) is the standard. (See the multisig setup guide for the how-to.)
...
## Member Contributions and Sweat Equity
...
## Earned Revenue: Money That Stays Local
...
A **fiscal host** is a legally registered organisation that holds and spends money on your behalf, so you can receive grants and pay people without incorporating your own entity. [Open Collective](https://opencollective.com/fiscal-hosting) is the best-known platform: your budget becomes a public ledger anyone can audit in real time. Hosts like The Social Change Nest take on the accounting and compliance so you don't have to.
...
**ReFi DAO's Local Node program** has funnelled grant capital to local nodes through Gitcoin and [Giveth](https://giveth.io/) match-funding pools (one Local Node round offered a $25k matching pool on Celo). Giveth itself is a zero-fee crypto donation platform with a [GIVbacks](https://giveth.io/givbacks) rewards program that gives donors GIV tokens, which can nudge more people to give.
...
| Funding model | What it pulls your community toward |
|---|---|
| Member fees | High ownership; risks excluding lower-income members |
| Grants | Growth, but drift toward funder priorities |
| Earned revenue | Sustainability, but a pull toward what sells |
| Sweat equity | High participation, real burnout risk |
...
>
> **Go deeper:** Set up a transparent treasury. Create a [Safe](https://safe.global) multisig with two or three trusted members, or open a collective on [Open Collective](https://opencollective.com/fiscal-hosting). Post the link to your group so every spend is visible.
>
> **Stretch:** Prepare for a real round. Browse current [Gitcoin Grants](https://grants.gitcoin.co/) and the [Greenpill Network](https://greenpill.network/) chapters, find the round that fits your work, and draft an application: a project page, a clear impact claim, and a list of community members who'd donate to trigger quadratic matching.

## References

- [Greenpill Network](https://greenpill.network/), global regen chapter network running quadratic funding rounds and minting hypercerts for local chapters.
- [Gitcoin Grants](https://grants.gitcoin.co/), quadratic-funding rounds for public goods; current GG24/3.0 round details and how to apply.
- [ReFi DAO](https://refidao.com/), regen coordination network; home of the Local Node program and match-funding history.
- [Giveth](https://giveth.io/), zero-fee crypto donation platform with GIVbacks rewards, used for regen project fundraising and match pools.
- [Open Collective, Fiscal Hosting](https://opencollective.com/fiscal-hosting), receive and spend money transparently without incorporating your own legal entity.
- [Hypercerts](https://hypercerts.org/), on-chain impact certificates for recording and retroactively funding regenerative work.
- [Safe](https://safe.global), the standard multisig wallet for shared, no-single-point-of-control community treasuries.
