---
title: Local Currency Design for Community Finance
description: A practical guide to designing and launching a community currency that
  works for your local node.
section: '2.9'
track: 2
status: published
author: Tej
...
*A practical guide to designing and launching a community currency that works for your local node*
...
The unit is what you count in. The choice shapes everything else.
...
Most new community currencies start with a time-based unit because it is intuitive and because it aligns with values of equality. If your group is more focused on local trade between businesses, a value-based unit may make more sense.

### 2. What Backs It?

Backing determines what gives the currency its value and what happens if the system faces problems.

**Nothing (fiat)**: The currency has value because people trust it will be accepted. Works if the community is tight-knit. Simplest but most fragile.

**Backed by labour**: Each unit represents an hour of work contributed. Most timebanks work this way. No reserves needed.

**Backed by goods**: Currency exchanges for items in a community store or larder, giving it tangible support.

**Backed by national currency**: Pegged to the shilling or dollar, backed by reserves in a community account. Reduces volatility but requires managing those reserves.

Starting with simple labour-backing is usually the right call for a new community currency. It is democratic, requires no reserves, and the logic is easy to communicate.

### 3. Who Issues It?

Issuance determines who creates new currency and under what conditions.

**Member-issued**: Members create currency by contributing. The community decides what counts and how many units to assign. Most democratic.
...
Every currency needs clear rules covering:

- **Who can earn?** Just formal members, or anyone in the community?
- **What can be earned?** All labour, or only types the community approves?
- **What can be spent on?** Anything, or are there restrictions (e.g., no spending on alcohol)?
...
The technology you use to run the currency matters less than the social agreement behind it. Many working community currencies use no technology at all. Choose based on your community's capacity, not on what sounds impressive.

### Option 1: Paper and Ledgers (Simplest)

Physical vouchers, receipt books, or a simple handwritten ledger. Works well for small communities of under 50 people.

Pros: No technical barriers, easy to understand, no transaction fees, works offline, survives power cuts.

Cons: Manual record-keeping, harder to scale, vulnerable to loss or fraud, difficult to search or analyse.

This is the right starting point for almost every new community currency. If your group can meet in person regularly, paper is enough.

### Option 2: Shared Digital Ledger

A shared spreadsheet or database that tracks balances. One person or a small team manages the ledger, or members can view a shared document.

Pros: Easier tracking and transparency, can handle more members, searchable, can be accessed from a phone.

Cons: Still requires trust in whoever manages the system, no resistance to censorship or interference, depends on internet access or device availability.

If your community has good phone access and someone willing to manage the records, a spreadsheet or a simple database is a reasonable step up from paper.

### Option 3: Blockchain-Based

A smart contract or token tracks balances on a distributed ledger.

Pros: Transparent and verifiable by anyone, no single point of control, programmable rules, can integrate with other systems.
...
- Open membership to a wider circle
- Formalise governance so the currency survives its founders
- Consider technical upgrades only if you are hitting real limits
- Develop training so new members can join easily

Scaling before the currency is solid is one of the most common mistakes. Make sure the pilot group is genuinely trading before opening the doors to everyone.
...
Do not launch with tokens, smart contracts, and DeFi integrations. Start with paper or a spreadsheet. Get the social agreement right first.
...
If your community operates within a clan structure, a religious network, or an informal market, your currency needs to work within those systems. Adjust rules about who can issue, how disputes are resolved, and what counts as acceptable labour.

### No Expiry or Community Fund

Without some mechanism to return currency to circulation, early participants hoard and new people cannot earn. A small annual fee, a demurrage charge on saved units, or a community fund that spends units on public goods prevents this from happening.
...
- **Ithaca Hours** (New York, USA): Longest-running time-based currency, launched 1991. One Ithaca Hour equals one hour of labour.
...
**Map your local exchange landscape**
...
Write this down. The gaps and patterns you find are the design brief for your currency.
