---
title: Is a DAO Right for Your Community?
description: A plain-language guide to help permaculture communities and grassroots
  groups decide if DAO structure is the right fit.
section: '1.8'
track: 1
status: published
author: unknown
...
*A plain-language guide for permaculture communities and grassroots groups*
...
- What a DAO actually is, in plain language
- Whether your permaculture project or community group could benefit from one
- Simple questions to ask before choosing this path
...
## When a DAO Might Work Well for Your Community

A DAO could be a good fit if your group values these things:
...
DAOs live on the internet, so anyone with internet access can join from anywhere. If your community spans different countries or time zones, this removes barriers that would otherwise exclude people.

For East African communities with diaspora members in Europe, North America, or the Gulf, this can be a real advantage.
...
DAOs often give members tokens for their work. Contribute to the garden, earn a token that also gives you more voting power. This creates a sense of ownership and aligns incentives with the community's goals.

---

## When a DAO Might Not Be Right for You

DAOs are not magic. They come with real challenges.
...
Before choosing a DAO structure, gather your group and discuss:

1. **Do we need a central leader for speed and safety?** If yes, a DAO may frustrate more than help.
2. **Do we need formal legal status?** If yes, explore cooperatives or nonprofits instead.
3. **Are everyone comfortable with technology?** If not, start with simpler tools.
4. **Do we want all decisions and money visible to all members?** If yes, DAOs excel here.
5. **Will people actually vote?** Low turnout defeats the purpose.

---

## A Note on Alternatives

If a DAO feels like too much, consider:

- **Cooperatives:** Legal structures with shared ownership that work well for community enterprises
- **Consensus-based decision making:** Used by many permaculture groups, including sociocracy
- **Simple voting tools:** Google Forms, Loomio, or even paper ballots for low-tech communities
...
| If you want... | DAO might help | Traditional org might be better |
|---|---|---|
| Everyone to vote on everything | Yes | |
| Fast decisions in crises | | Yes |
| Radical transparency | Yes | |
| Legal protection | | Yes |
| Global, inclusive membership | Yes | |
| Simple, low-tech setup | | Yes |
