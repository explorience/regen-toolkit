---
title: Inclusive Practices for Community Finance
description: How to design community finance systems that welcome and serve diverse
  participants, regardless of background, ability, or experience.
section: '2.4'
track: 2
status: published
author: Tej
...
Inclusion is not one thing. It operates across multiple dimensions:

### Economic Inclusion
Can people with limited financial resources participate?
...
### Technical Inclusion
Can people with limited technical knowledge participate?
...
### Temporal Inclusion
Can people with limited time participate?
...
### Social Inclusion
Can people from different backgrounds participate?
...
Words signal who belongs and who does not.
...
- Ask: "Is this clear?" and actually wait for the answer

**Do not:**
- Use jargon without explanation — terms like "gas fees," "rug pull," or "DeFi" need defining
...
Not everyone enters the same way. Create options:
...
Default practices center whoever designed them. Rotate:
...
Do not assume people know they are welcome. Say it directly:

- "This is for anyone interested in local exchange"
...
- Ask about barriers directly: "What is preventing you from participating more?"
...
Inviting diverse people but not changing power structures. True inclusion means sharing power, not just having diverse faces in the room.

### One-Size-Fits-All Design
Designing for a hypothetical average person who does not exist. Multiple options beat single defaults every time.

### Burden on Marginalized Groups
Expecting excluded people to educate others, do inclusion work, or represent their entire group. This is labor. Compensate it or redistribute it.

### Accessibility as Afterthought
Retrofitting accessibility is expensive and incomplete. Design inclusively from the start.

### Measuring Participation, Not Belonging
Counting heads is not enough. Do people feel valued? Do they contribute? Do they stay?
...
### Financial Literacy
Not everyone understands economics, tokens, or accounting.
...
### Technical Barriers
Wallets, keys, blockchain — these can be intimidating, especially for people who have never used a smartphone for financial transactions before.
...
### Time Poverty
Those most excluded from traditional finance often work multiple jobs, run households, or have extensive care responsibilities. Asking them to attend evening meetings or spend hours learning new technology is a significant ask.
...
- Remember that "free" time is itself a resource — people with more of it should not dominate

### Trust Barriers
Those harmed by extractive financial systems — banks that refused them service, predatory lenders, institutions that dismissed their communities — may distrust any financial system, including yours.
...
Beyond practices, culture matters:

- Name exclusion when you see it: "I noticed we just used a lot of jargon. Let me translate."
- Welcome questions — no question is too basic
- Correct condescension: "That is not a dumb question. It is a good one."
...
Beyond culture and individual practices, think about your systems:
...
Look at your last community event or meeting through the eyes of someone who has never been. Ask yourself:
...
Inclusion is not a box to check. It is an ongoing practice. There is no destination where you have arrived and the work is done.
...
- Inclusive community design principles
