...
> 🔧 **For Practitioners:** **GitBook** has a generous free tier and is free for open-source and nonprofit projects, with GitHub/GitLab sync. But custom domains and team collaborators require the Premium plan, which starts at $65/month. Fine for a polished public handbook; check the boundary before you depend on a feature that lives behind the paywall.
