...
You've got a community garden, a reforestation crew, or a local repair café, and you need a few thousand dollars to keep it going. One wealthy backer could write the cheque, but then you're beholden to one person's whims. What if 300 neighbours each giving $5 could pull in far more than $1,500?

That is exactly what quadratic funding is built to do. Below: the mechanism, a real regen round that used it, and a path to running one for your own node without setting yourself on fire.
...
The hard part isn't the software. It's everything around it: raising a real matching pool, recruiting genuine projects, and getting enough real humans to donate during a short window. That last one decides whether QF works at all.
