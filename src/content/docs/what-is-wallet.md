...
description: "A plain-language guide to crypto wallets for community organisers and permaculturists new to Web3, covering keys, recovery, safety, and energy use."
---
...
That asymmetry is the whole trick: one key invites people in to give, the other keeps them out unless it's you.

## The recovery phrase: your master backup
...
## You may not even need a phrase anymore
...
The **Base App** (Coinbase's wallet, which replaced the older Coinbase Wallet in 2025) and **Argent** let you sign in with a **passkey** — the same Face ID or fingerprint you already use to unlock your phone — and recover through your phone's secure backup or through trusted contacts you choose, instead of a written phrase. Argent calls those contacts **guardians**: friends or your own second device who can help you back in if you're locked out, but who can never spend your money. It's like asking a neighbour to hold a spare key without handing over the deed to your house.
...
A **cold wallet** stays offline. A **hardware wallet** — a small device like a **Ledger** or **Trezor**, about the size of a USB stick — holds your keys off the internet and only approves a payment when you physically confirm it on the device. It's the equivalent of a safe in the cellar: less convenient, far harder to rob from afar. People reach for one once they're holding more than they'd be comfortable losing.

| Wallet type | Convenience | Security | Good for |
|-------------|-------------|----------|----------|
| Hot wallet (phone/browser app) | High | Medium | Everyday giving and receiving |
| Cold wallet (hardware device) | Lower | High | Holding larger amounts longer-term |
...
- **Free-money bait.** A post shares a wallet's recovery phrase publicly with a "anyone can take the funds" hook. Import it and your own funds get drained instead. If it looks like free crypto, it's a trap.
...
> **Start here:** Practise the recovery-phrase habit before any money is involved. On paper, write 12 random words clearly and legibly, then read them back. That's the exact motion that protects a real wallet — getting comfortable with it now costs nothing and removes the fumbling later.
...
- [Britannica Money: Cryptocurrency Wallet](https://www.britannica.com/money/cryptocurrency-wallet) — clear definition of wallets, public/private keys, and hot vs cold storage.
- [Ledger Academy: What Is a Recovery Phrase](https://www.ledger.com/academy) — how recovery phrases work and why they must stay offline.
- [Bankless Academy: Wallet Basics](https://app.banklessacademy.com/lessons/wallet-basics) — free interactive lesson on wallets as your gateway to Web3.
- [Giveth](https://giveth.io/) — zero-fee crypto donation platform for community and climate projects; a real-world reason a wallet is useful.
- [Coinbase Help: Smart Wallet and Passkeys](https://help.coinbase.com/en/wallet/getting-started/smart-wallet-passkeys) — how passkey-based wallets recover access without a written seed phrase.
- [Argent: Guardians and Social Recovery](https://www.argent.xyz/) — wallet recovery through trusted contacts instead of a seed phrase.
- [Kaspersky: The Free Seed Phrase Scam](https://www.kaspersky.com/blog/cryptowallet-free-seed-phrase-scam/52810/) — how the "free money" recovery-phrase trap works and how to spot it.
- [Ethereum.org: The Merge and Energy Use](https://ethereum.org/en/roadmap/merge/) — Ethereum's switch to proof-of-stake and the ~99.9% drop in energy consumption.
