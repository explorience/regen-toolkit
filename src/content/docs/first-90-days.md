---
title: "Your First 90 Days Running a Local Node"
description: "A paced, source-backed playbook for standing up a local ReFi node without burning out or building something nobody shows up to."
---

# Your First 90 Days Running a Local Node
...
## Days 1-30: Convene before you build
...
## Days 31-60: Distribute the work early
...
## Days 61-90: Fund the thing, carefully
...
- [Starting a ReFi Local Node in Your Community, Regen Coordination Hub](https://hub.regencoordination.xyz/t/starting-a-refi-local-node-in-your-community/236): the canonical definition of a local node and how to begin.
- [Welcome to the Local Node Beta Incubator, ReFi DAO](https://blog.refidao.com/local-node-beta-incubator/): the curriculum, Liberating Structures, Luma, and monthly cadence.
- [Gitcoin Grants & ReFi Medellín: interview with Tereza Bízková](https://medium.com/@szutungchen/gitcoin-grants-local-refi-initiatives-an-interview-with-tereza-b%C3%ADzkov%C3%A1-of-refi-medell%C3%ADn-070ee0bd7e6a): concrete founding story, funding numbers, and real pitfalls.
- [ReFi DAO Wrapped 2024](https://blog.refidao.com/refi-dao-wrapped-2024/): network-wide funding, event counts, and incubator participation figures.
- [How Do We Keep Going? Activist Burnout, Commons Social Change Library](https://commonslibrary.org/how-do-we-keep-going-activist-burnout-and-personal-sustainability-in-social-movements/): distributing roles, pacing, and the signs of burnout.
- [Glo Dollar](https://www.glodollar.org/): a public-goods-funding stablecoin used as a node treasury example.
- [Greenpill Network](https://greenpill.network/): an alternative chapter network with local nodes worldwide.
